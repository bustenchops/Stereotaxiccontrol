...
#Setup GUI LAYOUT
        ...
        self.APmanualenter.setGeometry(QRect(520, 360, 75, 40))
        ...
        self.MLmanualenter.setGeometry(QRect(520, 410, 75, 40))
        ...
        self.DVmanualenter.setGeometry(QRect(520, 460, 75, 40))
