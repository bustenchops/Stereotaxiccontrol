...
class mainprogram:
 ...
 #       self.DVroto = RotaryEncoder(buttonprogram.rotoA_DV, buttonprogram.rotoB_DV, buttonprogram.misc_eventbuttonB, Letsgonow.DV_event)
    ...
    def executerrrr(self):
        ...
        quest = input('Test the AP stepper # steps in calibration variable using direction forward')
...
#        GPIO.output(buttonprogram.directionAP, buttonprogram.APforward)
        ...
        while count <= mainprogram.calibrationsteps:
            print("start")
            if GPIO.input(mainprogram.limitAP) == 1:
        ...
        quest = input('Test the AP stepper # steps in calibration variable using direction back')
        ...
        quest = input('Test the ML stepper # steps in calibration variable  using direction left')
        ...
        quest = input('Test the ML stepper # steps in calibration variable  using direction right')
        ...
        quest = input('Test the ML stepper # steps in calibration variable  using direction up')
        ...
        quest = input('Test the DV stepper # steps in calibration variable  using direction down')
