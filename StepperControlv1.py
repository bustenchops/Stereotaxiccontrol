...
class Steppercontrol:
    ...
    def steppgo(self,move_direction, speed, btwnsteps):
        ...
        if self.axis == 1:
            if var_list.APsteps-var_list.stepper_speed < 0 and var_list.zerotrigger == 0:
                self.zerolimit = 0
                print('negative movement and zero tigger hit')
        elif self.axis == 2:
            if var_list.MLsteps - var_list.stepper_speed < 0 and var_list.zerotrigger == 0:
                self.zerolimit = 0
                print('negative movement and zero tigger hit')
        elif self.axis == 3:
            if var_list.DVsteps - var_list.stepper_speed < 0 and var_list.zerotrigger == 0:
                self.zerolimit = 0
                print('negative movement and zero tigger hit')

        if var_list.emergencystopflag == 0 and self.zerolimit == 1:
